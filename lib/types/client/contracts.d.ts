export type TunnelFailureCode = 'address-parse-failed' | 'checksum-mismatch' | 'download-failed' | 'execution-denied' | 'proxy-bind-failed' | 'startup-timeout' | 'target-unavailable' | 'tunnel-exited' | 'unsupported-platform';
interface TunnelSnapshotBase {
    readonly generation: number;
    readonly updatedAt: number;
}
export type TunnelSnapshot = (TunnelSnapshotBase & {
