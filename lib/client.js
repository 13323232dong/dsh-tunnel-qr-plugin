	...
	factory: (require) => {
		...
		function buildTunnelQrOverlayView(snapshot, handlers) {
			return react.default.createElement(react.default.Fragment, null, react.default.createElement("button", {
				...
				color: "#555",
				minHeight: "18px"
			} }, describeStatus(snapshot)), snapshot.qr === null ? react.default.createElement("div", { style: {
				display: "grid",
				placeItems: "center",
				width: "min(300px, 100%)",
				aspectRatio: "1 / 1",
				...
				alt: "DSH 公网访问二维码",
				style: qrStyle
			}), snapshot.error === null ? null : react.default.createElement("div", {
				role: "status",
				style: {
					marginTop: "10px",
					color: "#b91c1c",
			...
			}, snapshot.error), react.default.createElement("div", { style: {
				...controlRowStyle,
		...
		function describeStatus(snapshot) {
			...
			switch (status.status) {
				...
				case "failed": return `${status.message}${status.retryable ? " 可尝试刷新。" : ""}`;
